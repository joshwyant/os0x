...
alignas(DefaultKernelContext) static uint8_t kernelBuf[sizeof(DefaultKernelContext)];
...
DefaultKernelContext::DefaultKernelContext(KernelBootstrapper &bootstrapper)
    : pageAllocator_{bootstrapper.memoryBootstrapper()},
      ...
      pageTables_{memoryLayout_,
                  pageAllocator_,
                  virtualMemoryAllocator_,
                  bootstrapper.memoryBootstrapper()},
      pageAllocatorPtr_(&bootstrapper.memoryBootstrapper().bootstrapAllocator())
{
